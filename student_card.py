...
class StudentCard:
    ...
    def create_widgets(self):
        ...
        txt_id = Entry(self.main_frame, textvariable=self.var_id, font=("King", 15, "bold"), bg="lightyellow", state='readonly')
        txt_id.place(x=200, y=60, width=250)

        lbl_name = Label(self.main_frame, text="Name", font=("King", 15, "bold"), bg="white")
        lbl_name.place(x=30, y=100)
        txt_name = Entry(self.main_frame, textvariable=self.var_name, font=("King", 15, "bold"), bg="lightyellow", state='readonly')
        txt_name.place(x=200, y=100, width=250)

        lbl_email = Label(self.main_frame, text="Email", font=("King", 15, "bold"), bg="white")
        lbl_email.place(x=30, y=140)
        txt_email = Entry(self.main_frame, textvariable=self.var_email, font=("King", 15, "bold"), bg="lightyellow", state='readonly')
        txt_email.place(x=200, y=140, width=250)

        lbl_gender = Label(self.main_frame, text="Gender", font=("King", 15, "bold"), bg="white")
        lbl_gender.place(x=30, y=180)
        txt_gender = Entry(self.main_frame, textvariable=self.var_gender, font=("King", 15, "bold"), bg="lightyellow", state='readonly')
        txt_gender.place(x=200, y=180, width=250)

        lbl_contact = Label(self.main_frame, text="Contact", font=("King", 15, "bold"), bg="white")
        lbl_contact.place(x=30, y=220)
        txt_contact = Entry(self.main_frame, textvariable=self.var_contact, font=("King", 15, "bold"), bg="lightyellow", state='readonly')
        txt_contact.place(x=200, y=220, width=250)

        lbl_address = Label(self.main_frame, text="Address", font=("King", 15, "bold"), bg="white")
        lbl_address.place(x=30, y=260)
        txt_address = Entry(self.main_frame, textvariable=self.var_address, font=("King", 15, "bold"), bg="lightyellow", state='readonly')
        txt_address.place(x=200, y=260, width=250, height=100)

        # =======column 2=========
        lbl_dob = Label(self.main_frame, text="D.O.B", font=("King", 15, "bold"), bg="white")
        lbl_dob.place(x=500, y=60)
        txt_dob = Entry(self.main_frame, textvariable=self.var_dob, font=("King", 15, "bold"), bg="lightyellow", state='readonly')
        txt_dob.place(x=670, y=60, width=250)

        lbl_state = Label(self.main_frame, text="State", font=("King", 15, "bold"), bg="white")
        lbl_state.place(x=500, y=140)
        txt_state = Entry(self.main_frame, textvariable=self.var_state, font=("King", 15, "bold"), bg="lightyellow", state='readonly')
        txt_state.place(x=670, y=140, width=250)

        lbl_city = Label(self.main_frame, text="City", font=("King", 15, "bold"), bg="white")
        lbl_city.place(x=500, y=180)
        txt_city = Entry(self.main_frame, textvariable=self.var_city, font=("King", 15, "bold"), bg="lightyellow", state='readonly')
        txt_city.place(x=670, y=180, width=250)

        lbl_pin = Label(self.main_frame, text="Pin", font=("King", 15, "bold"), bg="white")
        lbl_pin.place(x=500, y=220)
        txt_pin = Entry(self.main_frame, textvariable=self.var_pin, font=("King", 15, "bold"), bg="lightyellow", state='readonly')
        txt_pin.place(x=670, y=220, width=250)

        lbl_course = Label(self.main_frame, text="Course", font=("King", 15, "bold"), bg="white")
        lbl_course.place(x=500, y=100)
        txt_course = Entry(self.main_frame, textvariable=self.var_course, font=("King", 15, "bold"), bg="lightyellow", state='readonly')
        txt_course.place(x=670, y=100, width=250)
...
if __name__ == "__main__":
    ...
    obj = StudentCard(root, student_id=1)  # Replace with actual student ID
    root.mainloop()

...
class resultClass:
    def __init__(self,root):
        ...
        btn_search=Button(self.root,text='Search',font=("times new roman",15,"bold"),bg="#604abd",fg="white",cursor="hand2").place(x=500,y=100,width=100,height=28)
        ...
        #=====button======
        btn_add = Button(self.root,text="Submit",font=("King",15),bg="#e0d2ef",activebackground="lightgreen",cursor="hand2").place(x=300,y=420,width=120,height=35)
        btn_add = Button(self.root,text="Clear",font=("King",15),bg="#ffb3d2",activebackground="lightgrey",cursor="hand2").place(x=430,y=420,width=120,height=35)

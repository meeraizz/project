...
class teacherprofile:
    def __init__(self, root):
        ...
        #============Widgets==========
        lbl_select = Label(self.root, text="Select Teacher", font=("times new roman", 25, "bold"), bg="#fff0f3")
        ...
        self.txt_teacher = ttk.Combobox(self.root, textvariable=self.var_teacher_tid, font=("times new roman", 20, "bold"), state='readonly', justify=CENTER)
    ...
    def search(self):
        ...
        if selected_tid:
            ...
            cur = conn.cursor()
            try:
                cur.execute("SELECT name, email, contact, profile_picture FROM teacher WHERE tid=?", (selected_tid,))
